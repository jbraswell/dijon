...
Revision ID: f064763f709c
Revises: 2e5309fed3ad
Create Date: 2022-02-01 18:58:30.621353
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('root_server_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    sa.Column('source_id', sa.Integer(), nullable=True),
    sa.Column('name', sa.String(length=255), nullable=True),
    sa.Column('key_string', sa.String(length=255), nullable=True),
    ...
    sa.Column('service_body_id', sa.Integer(), nullable=True),
